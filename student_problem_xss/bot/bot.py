...
while True:
    try:
        r = requests.get('http://123.207.24.193:8099/xss1/read233333333_message.php')
        hash1 = r.text
        if hash1.strip()!='':
            print hash1
            ...
            try:
                ...
                driver.get('http://123.207.24.193:8099/xss1/')
                #driver.get('http://123.207.24.193:8087/test_bot.php')
                driver.add_cookie({'name': 'flag',
                                   'value' : 'flag{wonderful_perfect_excellent_23333333}',
                                   'path' : '/',
                                 })
                #driver.close()
                #time.sleep(1)
                driver.get('http://123.207.24.193:8099/xss1/admin233333333_message.php')
                #driver.get('http://123.207.24.193:8087/test_bot.php')
