...
--
-- Host: localhost    Database: ddctf_java_web_ssrf
-- ------------------------------------------------------
...
CREATE DATABASE `ddctf_java_web_ssrf` /*!40100 DEFAULT CHARACTER SET utf8 */;
use `ddctf_java_web_ssrf`;
...
INSERT INTO `role` VALUES (1,'admin','admin','管理员'),(2,'guest','guest','访客'),(3,'super_admin','super_admin','超级管理员');
...
INSERT INTO `user` VALUES (1,'admin','admin_password_2333_caicaikan',NULL,NULL),(2,'superadmin_hahaha_2333','su@3_l%o^ng&paSsw0rds',NULL,NULL);
...
INSERT INTO `user_role` VALUES (1,1,1),(2,1,2),(3,2,3),(4,2,2);
...
-- Dump completed on 2018-02-14 22:06:58
